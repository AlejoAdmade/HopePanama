...
window.HOPE_DATA = {
  doctors: [
    {
      id: "natalie-buitron",
      name: "Dra. Natalie Buitrón",
      specialty: "Hematóloga",
      image: "images/doctor-1.png",
      position: "50% 25%",
      instagram: "https://www.instagram.com/",
      intro: "Acompañamiento clínico enfocado en trastornos de la sangre, diagnóstico oportuno y seguimiento integral.",
      bio: "La Dra. Natalie Buitrón integra la evaluación clínica, la interpretación de estudios especializados y un plan de seguimiento claro para cada paciente. Su consulta se apoya en la comunicación cercana y en decisiones compartidas con la familia.",
    ...
    {
      id: "ignacio-veliz",
      name: "Dr. Ignacio Véliz",
      specialty: "Oncólogo",
      image: "images/doctor-3.png",
      position: "50% 24%",
      instagram: "https://www.instagram.com/",
      intro: "Evaluación y tratamiento oncológico con una visión integral del bienestar y las necesidades de cada paciente.",
      bio: "El Dr. Ignacio Véliz se enfoca en convertir información clínica compleja en pasos concretos. Su práctica combina evaluación especializada, educación al paciente y coordinación con otras disciplinas cuando el caso lo requiere.",
      areas: ["Oncología médica", "Tumores sólidos", "Segundas opiniones", "Monitoreo de tratamientos"],
      education: ["Especialidad en Oncología — información demostrativa", "Medicina Interna — información demostrativa", "Entrenamiento en tratamientos oncológicos"],
      languages: "Español · Inglés",
      experience: "10+ años",
    ...
    },
    {
      ...
      bio: "El Dr. Yong Loo acompaña a sus pacientes desde la evaluación inicial hasta el seguimiento, integrando las necesidades médicas y personales en un plan que prioriza seguridad, calidad de vida y comunicación continua.",
    ...
    },
    {
      ...
      position: "50% 22%",
      instagram: "https://www.instagram.com/",
      intro: "Diagnóstico, tratamiento y seguimiento especializado de enfermedades de la sangre desde una perspectiva multidisciplinaria.",
      bio: "El Dr. Al Ávila aborda condiciones hematológicas desde una perspectiva multidisciplinaria, integrando pruebas diagnósticas, terapias ambulatorias y seguimiento para mantener una visión completa de la evolución clínica.",
      areas: ["Hematología clínica", "Linfomas y mieloma", "Terapias ambulatorias", "Evaluación diagnóstica"],
      education: ["Especialidad en Hematología — información demostrativa", "Medicina Interna — información demostrativa", "Actualización en terapias dirigidas"],
      languages: "Español · Inglés",
      experience: "13+ años",
    ...
    {
      id: "lidia-luna",
      name: "Mgter. Lidia Luna",
      specialty: "Especialista en PsicoOncología",
      ...
      bio: "Mgter. Lidia Luna acompaña el impacto emocional del proceso oncológico. Su trabajo ayuda a desarrollar recursos para manejar la ansiedad, comunicar necesidades y fortalecer la red de apoyo del paciente y su familia.",
